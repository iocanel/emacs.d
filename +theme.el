...
;;
(def-doom-theme doom-intellij
  "A dark theme inspired by Atom One Dark"

  ;; name        default   256       16
  ((bg         '("#262626" nil       nil            ))
   (bg-alt     '("#21242b" nil       nil            ))
   (base0      '("#262626" "black"   "black"        ))
   (base1      '("#3a3a3a" "#1e1e1e" "brightblack"  ))
   ...
   (orange     '("#e78779" "#dd8844" "brightred"    ))
   (green      '("#528369" "#99bb66" "green"        ))
   (teal       '("#4db5bd" "#44b9b1" "brightgreen"  ))
   (yellow     '("#ECBE7B" "#ECBE7B" "yellow"       ))
   (blue       '("#3e86a0" "#51afef" "brightblue"   ))
   (dark-blue  '("#2257A0" "#2257A0" "blue"         ))
   (magenta    '("#7567a6" "#c678dd" "brightmagenta"))
