...
#+begin_src emacs-lisp
    (use-package eglot-java
      :commands (eglot-java-project-new eglot-java-project-build-refresh eglot-jva-file-new eglot-java-run-main eglot-java-run-test)
...
#+begin_src emacs-lisp
    ...
    :bind (;; C-c bindings in `mode-specific-map'
           ...
           ("C-x C-b" . consult-buffer-other-window) ;; orig. switch-to-buffer-other-window
