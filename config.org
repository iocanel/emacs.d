...
#+begin_src emacs-lisp
    (use-feature java-mode
      ...
      (defvar jdtls-command-list `(,java-bin
                                   "-jar"
                                   ,jdtls-jar
                                   "-data"
                                   ...
                                   "-configuration"
                                   ,jdtls-config
                                   "-XX:+UseAdaptiveSizePolicy" "-XX:GCTimeRatio=4" "-XX:AdaptiveSizePolicyWeight=90" "-Xmx8G" "-Xms2G" "-Xverify:none") "Command to start jdtls")

      (defun my/jdtls-start-command (arg)
        "Creates the command to start jdtls"
        `(,java-bin "-jar" ,jdtls-jar "-data" ,lsp-java-workspace-dir "-configuration" ,jdtls-config "-XX:+UseAdaptiveSizePolicy" "-XX:GCTimeRatio=4" "-XX:AdaptiveSizePolicyWeight=90" "-Xmx8G" "-Xms2G" "-Xverify:none"))
               ...
               (content '((java-mode
                           (eval . (progn
                                     (setq lsp-session-file (concat (project-root (project-current)) ".lsp/session")
                                           ...
                                           (add-to-list 'eglot-server-programs (append '(java-mode) (my/jdtls-start-command nil)))))))))
