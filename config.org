...
*** Autosave
#+begin_src emacs-lisp
  (setq auto-save-list-file-prefix (concat my/local-dir "auto-save-list"))
#+end_src
*** Exit confirmation
  ...
  (use-package yasnippet
    ...
    (defun my/yas-maybe-activate-org-src-mode (orig-func &rest args)
      ...
      (when (org-in-src-block-p)
        (let* ((yas-extra-modes (list (intern (concat (my/get-org-src-mode) "-mode")))))
          (apply orig-func args))))

    (advice-add 'yas--modes-to-activate :around #'my/yas-maybe-activate-org-src-mode)

    ;; Globally enable yas snippet
    (yas-global-mode 1)
    :config
    (yas-reload-all)
