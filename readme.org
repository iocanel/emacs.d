...
(use-package dired-lock
  :straight (dired-lock :type git :host github :repo "iocanel/dired-lock.el")
...
#+begin_src emacs-lisp
  ...
  (use-package emacsql-sqlite :elpaca (emacsql-sqlite :host github :repo "magit/emacsql" :branch "main" :files ("emacsql-sqlite.el")))
...
(use-package quickmarks
  :elpaca (quickmarks :host github :repo "iocanel/quickmarks.el" :branch "main" :files (:defaults "*.el"))
...
#+begin_src emacs-lisp
(use-package gptel
  :elpaca (gptel :host github :repo "karthink/gptel" :ref "7bb353a582d11ce210bb0a5b77c53de564c28e67")
