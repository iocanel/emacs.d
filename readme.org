...
#+begin_src emacs-lisp
  (use-package popper
    ...
    (defun my/agenda-pop-up-frame-dissable()
...
(setq browse-url-browser-function 'my/browse-url-chromium-in-app-mode
      browse-url-chromium-arguments '("--user-data-dir=/home/iocanel/.sandbox/iocanel/.local/emacs-browser" "--user-cache-dir=/home/iocanel/.sandbox/iocanel/.cache/emacs-browser" "--class=EmacsBrowser"))
#+end_src
** UI
*** Appearance
**** All icons
...
#+end_src
**** COMMENT Fonts
Commented out, as it causes issues with the screen setup configured below.
